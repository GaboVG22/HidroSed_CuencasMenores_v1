...
st.markdown(
    """
<div class='hs-hero'>
  <h1>🌊 HidroSed Cuencas Menores v1.0 · < 100.000 km²</h1>
  <p>Plataforma técnica completa para cuencas menores a 100.000 km²: DEM OpenTopography, delimitación robusta, curvas, eje, secciones, hidrología, hidráulica 1D, sedimentos y socavación.</p>
...
st.info(
    ...
    "Modo recomendado: cuencas menores a 100.000 km². Permite mayor detalle topográfico y curvas de 1 m cuando el DEM y el tamaño de cuenca lo soportan."
)
    ...
    if not has("control_point"):
        ...
        with c3:
            area_limit = st.number_input(
                ...
                value=120000.0,
                step=5000.0,
                help="Para cuencas grandes o muy grandes se recomienda ajustar el margen hasta que la cuenca no toque el borde del DEM. Para cuencas de menores a 100.000 km² use descarga por partes."
            )
        ...
        if area < 10000:
            ...
            st.warning("El bbox supera 120.000 km². Puede ser pesado; usa descarga por partes y usa descarga por partes y curvas de 25 m, 50 m o 100 m para comenzar.")
    ...
    if not has("dem_path") or not has("control_point"):
        ...
        tipo_cuenca = st.selectbox(
            ...
            [
                ...
                "Límite alto (50.000 a 100.000 km²)",
                "Personalizado"
            ],
            index=1,
        ...
        presets_basin = {
            ...
            "Límite alto (50.000 a 100.000 km²)": dict(snap=10000, cells=20_000_000, simp=300, limit=100_000.0),
            "Personalizado": dict(snap=2500, cells=6_000_000, simp=80, limit=100_000.0),
        }
        ...
        if has("basin_metrics"):
            ...
            if float(m.get("area_km2", 0)) > 100000:
                st.warning("La cuenca delimitada supera 100.000 km². La app puede mostrar resultados preliminares, pero se recomienda dividir el análisis o aumentar la simplificación.")
...
with tabs[3]:
    ...
    if not has("dem_path"):
        ...
        preset = {
            ...
            "Límite alto: 50.000 a 100.000 km²": {
                "Rápido y liviano": (100, "Por teselas y unificado", 5000, 6, 6, 6_000_000),
                "Equilibrado recomendado": (50, "Por teselas y unificado", 10000, 8, 8, 10_000_000),
                "Alto detalle": (25, "Por teselas y unificado", 20000, 10, 10, 20_000_000),
                "Máximo detalle pesado": (10, "Por teselas y unificado", 30000, 12, 12, 20_000_000),
            },
            "Personalizado": {
