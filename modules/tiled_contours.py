...
def split_bbox_km2_strategy(area_km2: float) -> dict:
    ...
    if area <= 2500:
        return {"tile_rows": 3, "tile_cols": 3, "nota": "Prueba o cuenca pequeña"}
    if area <= 10000:
        return {"tile_rows": 5, "tile_cols": 5, "nota": "Cuenca media"}
    if area <= 50000:
        return {"tile_rows": 8, "tile_cols": 8, "nota": "Cuenca grande"}
    if area <= 200000:
        return {"tile_rows": 12, "tile_cols": 12, "nota": "Cuenca muy grande hasta 200.000 km²"}
    return {"tile_rows": 16, "tile_cols": 16, "nota": "Bbox extremo; use curvas de 100 m o 200 m para comenzar"}
