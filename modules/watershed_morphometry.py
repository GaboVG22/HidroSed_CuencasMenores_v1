...
def _mask_to_polygon(mask, transform, crs, simplify_m=80.0):
    """Vectoriza la máscara de cuenca sin scikit-image.

    Mantiene calidad técnica usando rasterio.features.shapes y Shapely,
    reduciendo dependencias que hacen lenta la compilación en Streamlit Cloud.
    """
